...
import {
  PermitForm,
  type PermitClientOption,
  type PermitCompanyOption,
  type PermitPartnerOption,
} from "@/components/app/PermitCard";
...
export function NewPermitButton({
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Add permit" size="lg">
        {flash && (
